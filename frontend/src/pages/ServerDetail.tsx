                                ...
                                {logFiles.length === 0 ? (
                                    ...
                                    <pre className="log-content-pre">
                                        <Ansi useClasses={false}>
                                            {(() => {
                                                const content = logContent || 'Chargement... ou fichier vide.';
                                                // If content already has extensive color codes, typically it might start or contain ESC char
                                                // But usually log files on disk (except console.log sometimes) are plain text.
                                                // We will perform a simple syntax highlighting pass.

                                                // Basic Hytale/Java log highlighting
                                                return content
                                                    ...
                                                    // Components: [Component] -> Magenta/Purple - refined to avoid matching [0m] if missed or numbers
                    ...
                    activeTab === 'webhooks' && (
                        <div className="card">
                            ...
                            <div className="empty-state">
                                ...
                                <p className="text-sm text-muted mb-4">
                                    Les webhooks sont stockés dans la configuration du serveur (base de données).
                                </p>
                                <button
